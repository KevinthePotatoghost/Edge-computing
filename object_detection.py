...
def load_darknet_weights(model, weights_file):
    ...
    assert len(wf.read()) == 0, 'Failed to read the data'
    wf.close()
...
def weights_download(out='yolov3.weights'):
    _ = wget.download('https://github.com/hank-ai/darknet/releases/download/v2.0/yolov3.weights', out='yolov3.weights')
